...
; Joseph M, Emma W, Arianna B
; CIS-11 Course Project B
; Desc. LC-3 Program that displays minimum, maximum,
; Average test scores with letter grade dependent on average 
; Test score value
...
INPUT_LOOP
    ...
    BRp INPUT_LOOP         ; Repeat for all scores
...
SUM_LOOP
    ...
    ; Adjust Average 
    ADD R4, AVG_SCORE, #15  ; Adjusted average by 60
    ADD R4, AVG_SCORE, #15
    ADD R4, AVG_SCORE, #15
    ADD R4, AVG_SCORE, #15
...
PROMPT      .STRINGZ "Enter test score (0-100) ODD ONlY: "	; setback within our code
...
; SINCE OUR CODE DOES NOT COMPILE, ILL INCLUDE PIECES OF CODE THAT WE MADE
; I (Emma) created this for assigning scores
; Determine the letter grade based on the score
	...
	LEA R4,SCORE      	; Reload the address of the score
	...
	LEA R1,SCORE      	; Reload the address of the score
...
; Data Section
SCORE .FILL x95     ; Change this value to test different scores
...
; ALSO,
; Joseph drafted this beginning of the program
...
AND R1, R1, #0
OUT
ADD R1, R3, R2		; ADD 'TENS' VALUE AND 'ONES VALUE
OUT			; ECHO
RET
